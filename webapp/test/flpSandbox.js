		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#maresselectionscreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"maresselectionscreen-display": {
								"semanticObject": "maresselectionscreen",
								"action": "display",
								"description": "Generic Selection Screen",
								"title": "SelectionScreen",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mares.selectionscreen",
									"url": sap.ui.require.toUrl("mares/selectionscreen")
								}
							}
						}
					}
